...
import { FACTEUR_DACHBORD_ROUTE, LOGIN_ROUTE, redirectToDachbord } from '../router'
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-6">
              <Link to={FACTEUR_DACHBORD_ROUTE} className="flex items-center gap-2">
                <img
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <DropdownMenuLabel>
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs leading-none text-muted-foreground">Facteur</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
                  <DropdownMenuGroup>
        ...
        <div>
          ...
          <main>
            <div  className='mx-auth px-10 space-y-4 py-4'>
              <div className='flex'>
                <div className={'border mr-2 rounded-l'}><SidebarFacteur/> </div>
