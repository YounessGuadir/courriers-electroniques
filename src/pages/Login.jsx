...
import { FORGOT_PASSWORD, redirectToDachbord } from '../router';

// Schéma de validation
const formSchema = z.object({
  email: z.string().email("Email invalide").min(2).max(50),
  password: z.string().min(8, "Mot de passe trop court").max(50),
});
...
export function Login() {
  ...
  async function onSubmit(values) {
    try {
      ...
      if (response?.data?.errors) {
        ...
        if (emailError) {
          form.setError("email", {
            message: Array.isArray(emailError) ? emailError.join(', ') : emailError,
          });
        }
        ...
        if (passwordError) {
          form.setError("password", {
            message: Array.isArray(passwordError) ? passwordError.join(', ') : passwordError,
          });
        }
      } else {
  ...
  return (
    <div className="flex min-h-[calc(100vh-137px)] bg-gradient-to-b from-muted/50 mt-15 ">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button 
                ...
                type="button"
              >
                <div className="absolute inset-0 w-3 bg-gradient-to-r from-primary/10 via-primary/20 to-transparent -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-500" />
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="pl-9 pr-10 transition-colors focus:border-primary"
                            disabled={isSubmitting}
                          />
                          <Button
                            type="button"
                            variant="ghost"
                            size="icon"
                            className="absolute right-0 top-0 h-full px-3 hover:text-primary"
                ...
                <Button 
                  ...
                  disabled={isSubmitting}
                >
                  <div className="absolute inset-0 w-3 bg-white/30 -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-500" />
                  {isSubmitting ? (
                    <>
