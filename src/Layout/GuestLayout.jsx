...
import { ADMIN_DACHBORD_ROUTE, CLIENT_DACHBORD_ROUTE, EMPLOYER_DACHBORD_ROUTE, LOGIN_ROUTE } from '../router'
import { ModeToggle } from '../components/mode-toggle'
import { Link } from 'react-router-dom';
import { ZapIcon, FacebookIcon, TwitterIcon, InstagramIcon, Facebook, Twitter } from 'lucide-react';
...
export default function GuestLayout() {
  ...
  useEffect(() => {
    if (authenticated) {
      navigate(CLIENT_DACHBORD_ROUTE)
    }
  }, []);
