...
import { CLIENT_AFFICHER_COLIER_ROUTE, FACTEUR_AFFICHER_COLIER_ROUTE, FACTEUR_DACHBORD_ROUTE } from "../router";


export function SidebarFacteur({className}) {
    const playlists =[
        'Playlist 1',
        'Playlist 2',
        ...
        <div className="flex-1 overflow-y-auto py-4 px-3">
          ...
          <div className="mb-6">
            ...
            <nav className="space-y-1">
              <NavItem
                to={FACTEUR_DACHBORD_ROUTE}
                icon={<LayoutDashboard className="h-5 w-5" />}
                label="Dashboard"
                active={isActive(FACTEUR_DACHBORD_ROUTE)}
                collapsed={collapsed}
              />
              <NavItem 
                to={FACTEUR_AFFICHER_COLIER_ROUTE}
                icon={<Mail className="h-5 w-5" />}
                label="Courrier Électronique"
                active={isActive(FACTEUR_AFFICHER_COLIER_ROUTE)}
                collapsed={collapsed}
              />
              <NavItem 
                to={'#'}
