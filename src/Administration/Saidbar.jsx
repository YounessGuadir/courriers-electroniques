...
import { CLIENT_AFFICHER_COLIER_ROUTE, CLIENT_DACHBORD_ROUTE, CLIENT_MANEGE_COLIER_ROUTE } from "../router";
          ...
          <div className="mb-6">
            ...
            <nav className="space-y-1">
              <NavItem
                ...
                label="Dashboard"
                active={isActive(CLIENT_DACHBORD_ROUTE)}
                collapsed={collapsed}
              />
              <NavItem 
                to={CLIENT_MANEGE_COLIER_ROUTE}
                icon={<Mail className="h-5 w-5" />}
                label="Courrier Électronique"
                active={isActive(CLIENT_MANEGE_COLIER_ROUTE)}
                collapsed={collapsed}
              />
              <NavItem 
                to={CLIENT_AFFICHER_COLIER_ROUTE}
